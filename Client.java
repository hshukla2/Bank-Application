...
public class Client {
	public static void main(String[] args) {
		...
		try
		{
			...
			int showBalance[]=bank.fundTransfer(101,102,500);
			System.out.println("---Fund Transferring---");
			System.out.println("Sender balance after fund transfer = "+showBalance[0]);
			System.out.println("Reciever balance after fund transfer = "+showBalance[1]);
			System.out.println("---Depositing---");
			System.out.println("Account balance after deposit = "+bank.depositAmount(101, 500));
